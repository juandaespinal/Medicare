...
export default function AgeQuestion({ onAgeSelect }: AgeQuestionProps) {
  return (
        ...
        <div className="p-6 bg-gray-50">
          <div className="mb-6">
            ...
            <div className="flex justify-center items-center mb-4">
              ...
              <span className="ml-3 text-gray-600 font-medium">Step 1/2</span>
            </div>

            {/* Question */}
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 mb-5">
              <h4 className="text-3xl font-bold text-center mb-2 text-gray-800">What is your age range?</h4>
