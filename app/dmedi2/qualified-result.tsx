    ...
    <div className="max-w-4xl mx-auto qualified-result">
      ...
      <div className="mb-6">
        ...
        <div className="text-center mb-6 px-4">
          <div className="inline-flex items-center justify-center space-x-2 text-gray-600 font-bold text-sm animate-bounce w-full max-w-xs">
            <ArrowDown className="w-5 h-5 flex-shrink-0" />
            <span className="whitespace-nowrap">See your full benefits below</span>
            <ArrowDown className="w-5 h-5 flex-shrink-0" />
          </div>
        </div>
      </div>
